...
export default function Quiz2() {
    ...
    const [endshow, setEndshow] = useState(true);
    ...
    return (
        <div className='quizContainer'>
            ...
            {
                (endshow) ? <button style={styleQ} className='start' onClick={endQuiz}>End</button> : <p></p>
            }
        </div>
    );
}